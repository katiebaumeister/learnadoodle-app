-- Add Calendar Schedule Data - FINAL CORRECTED VERSION (FIXED V2)
-- This includes all required fields for family_years table

-- ========================================
-- STEP 1: CREATE FAMILY_YEAR RECORD
-- ========================================
-- family_years uses global_year_id, not academic_year_id
-- Including required start_date and other fields
