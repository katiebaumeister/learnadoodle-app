-- Fix get_home_data RPC to exclude soft-deleted and canceled events from all CTEs
-- This ensures deleted tasks/events are removed from today's learning card and all other home data sections
