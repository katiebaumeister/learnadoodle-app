-- =====================================================
-- FIX get_month_view TO EXCLUDE CANCELED AND DELETED EVENTS
-- The issue: Planner calendar is showing canceled and deleted events
-- This matches the behavior of get_week_view and other event queries
-- =====================================================
