-- Parent marked-up files returned with assignment review feedback.

ALTER TABLE public.assignments
  ADD COLUMN IF NOT EXISTS linked_review_attachment_ids jsonb DEFAULT '[]'::jsonb;

COMMENT ON COLUMN public.assignments.linked_review_attachment_ids IS
  'Material IDs for parent-uploaded marked-up files attached during review.';
