-- Fix refresh_calendar_days_cache ON CONFLICT clause
-- The ON CONFLICT clause was referencing table aliases (o.date, c.id) which are not available
-- It should use EXCLUDED instead
