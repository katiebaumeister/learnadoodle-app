-- =====================================================
-- Add event_type to get_month_view function
-- This is needed for Project event expansion logic
-- =====================================================
...
events AS (
  SELECT
    ...
    e.end_ts,
    e.year_plan_id,
    e.event_type,  -- ADDED: Include event_type for Project expansion
  ...
  SELECT
    ...
    JSONB_AGG(
      JSONB_BUILD_OBJECT(
        ...
        'event_type', event_type,  -- ADDED: Include event_type in output
...
BEGIN
  RAISE NOTICE '╔════════════════════════════════════════╗';
  RAISE NOTICE '║  EVENT_TYPE ADDED TO GET_MONTH_VIEW     ║';
  RAISE NOTICE '╚════════════════════════════════════════╝';
  RAISE NOTICE '';
  RAISE NOTICE '✅ event_type column added to get_month_view query';
  RAISE NOTICE '✅ event_type included in JSONB output';
  RAISE NOTICE '✅ Project events can now be expanded across days';
END$$;
