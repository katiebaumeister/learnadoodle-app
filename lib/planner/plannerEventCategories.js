/** Planner calendar uses exactly four event categories with matching chip colors. */
...
export const PLANNER_EVENT_CATEGORIES = [
  ...
  { key: 'Day off', label: 'Day off', color: '#FFEDE2', chipText: '#9A3412', hoverColor: '#FFE2D2' },
];
...
/** Returns one of the four planner category labels. */
