 ...
 * Monochromatic purple chip fills — clear (Day off) through full purple (Event).
 * US public holidays stay blank chips (not tinted).
 */

/** Shared text on tinted chips */
const PLANNER_CHIP_TEXT = '#5B21B6';
const PLANNER_CHIP_ACCENT = '#7C3AED';
