...
export const PLANNER_EVENT_CATEGORIES = [
  { key: 'Event', label: 'Event', color: '#FFF1F2', chipText: '#BE185D', hoverColor: '#FFE4E6' },
  { key: 'Assignment', label: 'Assignment', color: '#FEFAD5', chipText: '#A16207', hoverColor: '#FEF9C3' },
  { key: 'Learning day', label: 'Learning day', color: '#E4F3FE', chipText: '#2B6CB4', hoverColor: '#D9EDFE' },
];
