/** Planner calendar filter categories; day-offs and US public holidays render as blank chips. */
...
export const PLANNER_EVENT_CATEGORIES = [
  ...
  { key: 'Day off', label: 'Day off', color: '#FFFFFF', chipText: '#111827', hoverColor: 'rgba(0, 0, 0, 0.02)' },
];
