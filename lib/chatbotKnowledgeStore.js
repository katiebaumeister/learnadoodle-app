 ...
 * Used for RAG over the app guide so Doodle can direct users ("Go to Subjects to see grades").
 */
 ...
 * Pass markdown string; in Node run from a script that reads docs/APP_GUIDE_FOR_CHATBOT_VECTOR_STORE.md.
