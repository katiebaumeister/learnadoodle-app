...
export async function listTemplates({ familyId, filters = {} }) {
  try {
    ...
    console.error('[templatesClient] Error listing templates:', err);
...
export async function createFromEvents({ 
  ...
  try {
    ...
    console.error('[templatesClient] Error creating template from events:', err);
    return { data: null, error: err };
  }
}
...
export async function applyTemplate({ templateId, childIds, startDate, familyId }) {
  try {
    ...
    console.error('[templatesClient] Error applying template:', err);
    return { data: null, error: err };
  }
}
...
export async function getTemplatePreview(templateId) {
  try {
    ...
    console.error('[templatesClient] Error getting template preview:', err);
    return { data: null, error: err };
  }
}
...
export async function createTemplateVersion({ templateId, versionNotes = null }) {
  try {
    ...
    console.error('[templatesClient] Error creating template version:', err);
    return { data: null, error: err };
  }
}
...
export async function listTemplateVersions(templateId) {
  try {
    ...
    console.error('[templatesClient] Error listing template versions:', err);
    return { data: null, error: err };
  }
}
...
export async function listLessonTemplates({ subjectId = null } = {}) {
  try {
    ...
    console.error('[templatesClient] Error listing lesson templates:', err);
    return { data: null, error: err };
  }
}
...
export async function createLessonTemplate({
  ...
  try {
    ...
    console.error('[templatesClient] Error creating lesson template:', err);
    return { data: null, error: err };
  }
}
...
export async function shareTemplate(templateId, { marketplace_description, marketplace_tags = [] }) {
  try {
    ...
    console.error('[templatesClient] Error sharing template:', err);
    return { data: null, error: err };
  }
}
