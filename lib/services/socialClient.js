...
export async function createGroup(groupData) {
  try {
    ...
    console.error('[socialClient] Error creating group:', err);
...
export async function listGroups(filters = {}) {
  try {
    ...
    console.error('[socialClient] Error listing groups:', err);
    return { success: false, error: err.message };
  }
}
...
export async function getGroupDetails(groupId) {
  try {
    ...
    console.error('[socialClient] Error getting group details:', err);
    return { success: false, error: err.message };
  }
}
...
export async function joinGroup(groupId, inviteCode = null) {
  try {
    ...
    console.error('[socialClient] Error joining group:', err);
    return { success: false, error: err.message };
  }
}
...
export async function shareResource(resourceData) {
  try {
    ...
    console.error('[socialClient] Error sharing resource:', err);
    return { success: false, error: err.message };
  }
}
...
export async function listSharedResources(filters = {}) {
  try {
    ...
    console.error('[socialClient] Error listing shared resources:', err);
    return { success: false, error: err.message };
  }
}
...
export async function createSharedClass(classData) {
  try {
    ...
    console.error('[socialClient] Error creating shared class:', err);
    return { success: false, error: err.message };
  }
}
...
export async function enrollInClass(classId, childId) {
  try {
    ...
    console.error('[socialClient] Error enrolling in class:', err);
    return { success: false, error: err.message };
  }
}
...
export async function createConnection(familyId) {
  try {
    ...
    console.error('[socialClient] Error creating connection:', err);
    return { success: false, error: err.message };
  }
}
...
export async function acceptConnection(connectionId) {
  try {
    ...
    console.error('[socialClient] Error accepting connection:', err);
    return { success: false, error: err.message };
  }
}
...
export async function createMarketplaceListing(listingData) {
  try {
    ...
    console.error('[socialClient] Error creating marketplace listing:', err);
    return { success: false, error: err.message };
  }
}
...
export async function listMarketplaceListings(filters = {}) {
  try {
    ...
    console.error('[socialClient] Error listing marketplace:', err);
    return { success: false, error: err.message };
  }
}
...
export async function purchaseListing(listingId) {
  try {
    ...
    console.error('[socialClient] Error purchasing listing:', err);
    return { success: false, error: err.message };
  }
}
...
export async function createReview(listingId, reviewData) {
  try {
    ...
    console.error('[socialClient] Error creating review:', err);
    return { success: false, error: err.message };
  }
}
