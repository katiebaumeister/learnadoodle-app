...
export async function getSubjectDetail(subjectId, familyId, childId = null, session = null) {
  ...
  try {
    ...
    try {
      const assignSelect =
        'id, title, description, child_id, due_date, start_work_by, need_help, help_message_log, linked_event_ids, linked_evidence_ids, linked_review_attachment_ids, status, review_status, review_feedback, reviewed_at, submitted_at, progress_percent, grade_display, grade_value, family_id, related_subject, updated_at, created_at';
