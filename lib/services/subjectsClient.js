...
export async function getSubjectDetail(subjectId, familyId, childId = null, session = null) {
  ...
  try {
    ...
    try {
      const assignSelect =
        'id, title, description, child_id, due_date, need_help, help_message_log, linked_event_ids, status, review_status, review_feedback, submitted_at, progress_percent, grade_display, grade_value, family_id, related_subject, updated_at, created_at';
