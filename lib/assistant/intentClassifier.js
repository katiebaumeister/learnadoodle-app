...
- navigate: user wants to jump to a screen (e.g. "open planner", "take me to feedback", "go to materials").
...
- list_materials: list or summarize items in Materials (not "open materials" — that is navigate).
- add_material: save a **web link** into Materials from chat (user includes https://… and words like add/save/materials/library). Not uploading a file from chat (tell them to use Materials). Not list_materials.
- delete_material: remove/archive a specific material by name (not deleting a calendar event).
- rename_material: rename a material / book / file (e.g. rename "Old" to "New" in Materials). Not renaming a child or calendar event.
