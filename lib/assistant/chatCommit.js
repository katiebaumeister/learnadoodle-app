...
export function summarizeArchiveChildProposal(name) {
  return `• ${(name || 'Child').trim()}\n• Hides them from family views until you restore in **Family**.`;
}
...
export function summarizeDeleteSubjectProposal(snapshot) {
  ...
  return `• ${n}\n• Permanently removes this subject and related events, materials, and syllabi. This cannot be undone.`;
}
