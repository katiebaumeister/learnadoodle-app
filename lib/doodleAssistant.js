...
function getDeterministicHowToReply(userMessage) {
  ...
  return 'Open Planner, click + New, create the event, then turn on Repeat. Choose Weekly or Monthly, pick the days, and under Ends choose On date (set the school-year end) or Term end if available. Save once and it will create the repeating series.';
}
