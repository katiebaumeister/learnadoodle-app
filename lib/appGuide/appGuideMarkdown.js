...
## How to set yearly schedule cadence
To set recurring cadence for **this year** or the **school year**: open **Planner** from the left sidebar, then use **Schedule setup** and **Planning Preferences** to set students, subjects, cadence, weekdays, and times for calendar placement. If you do not see scheduling controls, open **Subjects → Schedule** or **Family → Planning Preferences** first.
...
The Subjects area (sometimes routed as Intelligence or /intelligence on the web) is where you manage subjects, see progress-style summaries, and open curriculum tools such as schedule setup, curriculum generation, or parsing uploaded syllabi—depending on what your family has enabled. Open a subject to see details, pacing, and linked materials.
