...
export const STRINGS = {
  ...
  planMyYear: {
    modal: {
      ...
      /** Saved schedule list (inline planner) — same title scale as structuredClassPlansTitle. */
      editPlanTitle: "Manage schedule",
    ...
    multiSubjectUnits: {
      ...
      draftDeleteUnit: "Delete unit",
      draftEditUnit: "Edit unit",
      draftEditLesson: "Edit lesson",
    ...
    calendar: {
      ...
      slotTooltipEmpty:
        "This is an instructional slot created by Schedule setup. Fill it with a lesson or leave it open.",
      slotTooltipFilled:
  ...
  buildCurriculum: {
    ...
    placement: {
      ...
      useSlots: {
        ...
        helper:
          "Fill lessons into your schedule when possible.",
      },
      fallback: {
  ...
  calendarSlotActions: {
    emptySlot: {
      ...
      tooltip:
        "This slot was generated by Schedule setup. Fill it with a lesson or leave it open.",
    },
    filledSlot: {
