...
export function buildSubjectGettingStartedBulletinBody(subjectName) {
  ...
  return normalizeSubjectGettingStartedBulletinBody(`Welcome to ${name}! Here’s how to get started:

• Configure Schedule — Edit this subject and set dates to see recurring planner slots for ${name}.
• Edit units — add structured units and lessons under Classwork when you want a clear outline.
