...
export function calendarEventFormFromEvent(event) {
  ...
  return {
    ...
    startTime: event.all_day || event.is_flexible === true && !parseTimeLabelFromTs(startTs)
      ? ''
      : parseTimeLabelFromTs(startTs),
    endTime: event.all_day ? '' : parseTimeLabelFromTs(endTs),
