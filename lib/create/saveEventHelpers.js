...
export async function saveCalendarEvent({
  ...
  if (isBacklog) {
    ...
    const times = computeEventTimes({ date, startTime, endTime, allDay, allowOptionalTime: true });
    ...
    isFlexible = !allDay && !!times.isFlexible;
  }
...
export async function updateCalendarEvent({
  ...
  const times = computeEventTimes({ date, startTime, endTime, allowOptionalTime: true });
  if (!times.start || !times.end) {
    throw new Error('Date is required');
  }
