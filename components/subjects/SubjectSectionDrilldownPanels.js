...
const styles = StyleSheet.create({
  ...
  dayCellPresent: { backgroundColor: ATTENDANCE_COLORS.present },
  dayCellAbsent: { backgroundColor: ATTENDANCE_COLORS.absent },
  dayCellGraded: { backgroundColor: '#dbeafe' },
  dayCellUnmarked: { backgroundColor: ATTENDANCE_COLORS.unmarked },
