-- Final Corrected Demo Seed Data for Max and Lilly
-- This version includes all required columns based on the error message:
-- - age (required, NOT NULL)
-- - avatar (has default 'prof1')
-- - All other columns that exist in your schema
