-- Fix get_week_view RPC to use SECURITY DEFINER
-- This allows the FastAPI backend (using service role) to call it without RLS issues

-- First, check current definition
-- SELECT pg_get_functiondef('get_week_view'::regproc);
