...
# Cache the client instance (singleton)
...
def get_admin_client() -> Client:
    """Get Supabase client with service role (bypasses RLS) - cached singleton"""
    ...
    if _cached_client is None:
        ...
        _log("create_client.start", url=_SUPABASE_URL, key_length=len(_SUPABASE_SERVICE_ROLE_KEY))
        _cached_client = create_client(_SUPABASE_URL, _SUPABASE_SERVICE_ROLE_KEY)
