...
-- The issue: Month view shows wrong times (1 PM instead of 5 AM)
-- Week view is actually correct: 9 AM UTC = 5 AM Eastern
-- =====================================================
...
events AS (
  SELECT
    ...
    -- FIXED: Use same timezone conversion as get_week_view (which is correct)
...
BEGIN
  ...
  RAISE NOTICE 'Sample event for 2025-10-21: % at %', 
    test_result->'events_by_date'->'2025-10-21'->0->>'title',
